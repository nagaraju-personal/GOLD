...
public class Test_DGLD_Admin_Loq_004_CreateNewOrder_in_AdminPanel {
    ...
    public void CreateNewOrder_in_AdminPanel () throws Exception {
    try {
        ...
        Admin.validate_Guestuser_shippingaddress("Details");
