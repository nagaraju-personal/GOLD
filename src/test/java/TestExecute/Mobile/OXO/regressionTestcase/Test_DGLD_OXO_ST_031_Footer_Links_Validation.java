...
public class Test_DGLD_OXO_ST_031_Footer_Links_Validation {
	...
	GoldOxoHelper_Mobile Oxo = new GoldOxoHelper_Mobile(datafile,"Footer");
	...
	public void Validate_Footer_Links() throws Exception {
		...
		try {
			...
			Oxo.footerLinks_ProductSupport("ProductSupport");
			Oxo.footerLinks_CustomerSupport("CustomerSupport");
			Oxo.footerLinks_WeAre_Oxo("WeAreOXO");
