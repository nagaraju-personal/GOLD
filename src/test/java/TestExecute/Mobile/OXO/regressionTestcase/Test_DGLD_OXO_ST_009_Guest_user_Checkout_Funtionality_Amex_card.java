...
public class Test_DGLD_OXO_ST_009_Guest_user_Checkout_Funtionality_Amex_card {
	String datafile = "OXO//GoldOxoTestData.xlsx";	
	GoldOxoHelper_Mobile Oxo = new GoldOxoHelper_Mobile(datafile,"DataSet");
	
	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Validate_Guest_user_Checkout_Funtionality_Amex_card() throws Exception {
