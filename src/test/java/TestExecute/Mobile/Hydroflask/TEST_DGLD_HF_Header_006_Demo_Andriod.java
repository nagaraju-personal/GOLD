...
public class TEST_DGLD_HF_Header_006_Demo_Andriod {
	...
	public void Validate_authenticateduser_viewscontent() throws Exception {
		...
		try {
		   ...
		   Hydro.click_singinButton();
			/*
			 * Hydro.login_Hydroflask("AccountDetails"); Hydro.Validating_search();
			 * Hydro.minicart(); Hydro.Validate_Myaccountoptions("MyAccountoptions");
			 */
