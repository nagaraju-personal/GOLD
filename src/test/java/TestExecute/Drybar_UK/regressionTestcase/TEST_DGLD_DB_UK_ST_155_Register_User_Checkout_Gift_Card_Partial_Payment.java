...
public class TEST_DGLD_DB_UK_ST_155_Register_User_Checkout_Gift_Card_Partial_Payment {

	String datafile = "Drybar_UK//GoldDrybarUKTestData.xlsx";
	GoldDrybarUSHelper Drybar = new GoldDrybarUSHelper(datafile,"DataSet");

	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Validate_Register_user_Checkout_and_with_Parttial_Giftcode_CC () throws Exception {
