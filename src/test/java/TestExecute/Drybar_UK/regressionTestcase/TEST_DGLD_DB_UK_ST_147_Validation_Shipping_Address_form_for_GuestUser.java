...
public class TEST_DGLD_DB_UK_ST_147_Validation_Shipping_Address_form_for_GuestUser {

	String datafile = "Drybar_UK//GoldDrybarUKTestData.xlsx";
	GoldDrybarUSHelper Drybar = new GoldDrybarUSHelper(datafile,"DataSet");

	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Validate_Shipping_Address_form_for_GuestUser () throws Exception {
		...
		try {
			...
			Drybar.Shippingform_Guestuser("Invalid details");
