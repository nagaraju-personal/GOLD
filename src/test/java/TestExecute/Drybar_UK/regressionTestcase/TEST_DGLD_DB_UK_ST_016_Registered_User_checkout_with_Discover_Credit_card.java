...
public class TEST_DGLD_DB_UK_ST_016_Registered_User_checkout_with_Discover_Credit_card {

	String datafile = "Drybar_UK//GoldDrybarUKTestData.xlsx";
	GoldDrybarUSHelper Drybar = new GoldDrybarUSHelper(datafile,"DataSet");

	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Validate_Registered_User_checkout_with_Discover_Credit_card () throws Exception {
