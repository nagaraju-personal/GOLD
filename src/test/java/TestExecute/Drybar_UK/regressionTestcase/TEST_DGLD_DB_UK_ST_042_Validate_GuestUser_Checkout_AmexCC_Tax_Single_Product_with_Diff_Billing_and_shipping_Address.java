...
public class TEST_DGLD_DB_UK_ST_042_Validate_GuestUser_Checkout_AmexCC_Tax_Single_Product_with_Diff_Billing_and_shipping_Address {

	String datafile = "Drybar_UK//GoldDrybarUKTestData.xlsx";
	GoldDrybarUSHelper Drybar = new GoldDrybarUSHelper(datafile,"DataSet");

	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Validate_GuestUser_Checkout_AmexCC_Tax_Single_Product_with_Diff_Billing_and_shipping_Address () throws Exception {
