...
public class Test_DGLD_CS_E2E_010_GuestUser_Simple_FreeSampleItem_Purchase_CC {
	...
	public void Verifying_GuestUser_Simple_FreeSampleItem_Purchase_CC() throws Exception {

		try {
			curlsmith.prepareOrdersData("CurlsmithUS_E2E_orderDetails.xlsx");
			String Description = "Guest User simple + Free Sample Item Purchase + CC";
