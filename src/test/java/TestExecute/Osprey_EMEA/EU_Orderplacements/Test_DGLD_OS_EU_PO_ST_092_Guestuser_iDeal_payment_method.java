...
public class Test_DGLD_OS_EU_PO_ST_092_Guestuser_iDeal_payment_method {
	...
	public void Verifying_Guestuser_iDeal_payment_method() throws Exception {
        ...
        Osprey_ReEu.iDeal_payment("iDeal");
