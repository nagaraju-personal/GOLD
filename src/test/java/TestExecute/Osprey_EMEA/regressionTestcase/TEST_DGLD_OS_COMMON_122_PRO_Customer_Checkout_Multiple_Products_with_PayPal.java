...
public class TEST_DGLD_OS_COMMON_122_PRO_Customer_Checkout_Multiple_Products_with_PayPal {

	String datafile = "Osprey_EMEA//GoldOspreyemea.xlsx";
	OspreyEMEA_HYVA Osprey_ReEu = new OspreyEMEA_HYVA(datafile,"Checkout payments");

	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Verifying_PRO_Customer_Checkout_Multiple_Products_with_PayPal () throws Exception {
