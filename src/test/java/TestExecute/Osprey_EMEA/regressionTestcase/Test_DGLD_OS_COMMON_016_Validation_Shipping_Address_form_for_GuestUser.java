...
public class Test_DGLD_OS_COMMON_016_Validation_Shipping_Address_form_for_GuestUser {

	String datafile = "Osprey_EMEA//GoldOspreyemea.xlsx";
	OspreyEMEA_HYVA Osprey_ReEu = new OspreyEMEA_HYVA(datafile,"Checkout payments");

	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Verifying_the_Shipping_Address_form_for_GuestUser () throws Exception {
