...
public class Test_DGLD_OS_COMMON_130_PRO_Customer_Checkout_With_3DSecure_Payment_Method {

	String datafile = "Osprey_EMEA//GoldOspreyemea.xlsx";
	OspreyEMEA_HYVA Osprey_ReEu = new OspreyEMEA_HYVA(datafile,"Checkout payments");

	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Verifying_PRO_Customer_Checkout_With_3DSecure_Payment_Method () throws Exception {
