...
public class GmailAPI {
    private static final String APPLICATION_NAME = "HelenofTroy";
    ...
    public static HashMap<String, String> getGmailData(String query) {
        try {
            ...
            System.out.println("Mail Message : "+message.toString());
            JsonPath jp = new JsonPath(message.toString());
            String subject = jp.getString("payload.headers.find { it.name == 'Subject' }.value");
            //System.out.println("Body Data :"+jp.getString("payload.body.data"));
           // System.out.println("Decrypted Body Data :"+StringUtils.newStringUtf8(Base64.decodeBase64((jp.getString("payload.body.data")))));
            String body = StringUtils.newStringUtf8(Base64.decodeBase64(jp.getString("payload.body.data")));
			/*
			 * String link = null;
			 * 
			 * String arr[] = body.split("\n"); for(String s: arr) { s = s.trim();
			 * if(s.startsWith("http") || s.startsWith("https")) { link = s.trim(); } }
			 */
    ...
    public static boolean isMailExist(String messageTitle) {
        ...
        public static String getLink(String mailBody) {
        	String link="";
        	
        	String patternString ="\\s*(?i)href=(\"([^\"]*\")|'[^']*'|([^'\">\\s]+))";

            Pattern pattern = Pattern.compile(patternString);
            Matcher matcher =pattern.matcher(mailBody);
            while(matcher.find()) {
            	if(matcher.group(1).contains("createPassword")) {
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        HashMap<String, String> hm = getGmailData("\"Revlon Hair Tools Your Order Confirmation\"");
        ...
        System.out.println("=================");
        //System.out.println(hm.get("body").contains("Order 81000006416"));
        /*System.out.println("Total count of emails is :"+getTotalCountOfMails());
        
        System.out.println("=================");
        boolean exist = isMailExist("Your Password Reset Request");
